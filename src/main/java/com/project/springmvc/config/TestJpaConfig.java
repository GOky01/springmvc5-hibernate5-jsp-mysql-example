...
@Configuration
@EnableJpaRepositories(basePackages = "com.project.springmvc.repository")
@PropertySource("classpath:h2-database.properties")
@EnableTransactionManagement
public class TestJpaConfig {

    private final Environment environment;

    public TestJpaConfig(Environment environment) {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("com.project.springmvc.entity");
